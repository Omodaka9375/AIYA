...
if __name__ == "__main__":
    ...
    if (not args.input_audio) and (not args.input_background):
        ...
        subprocess.call('python3 main.py ' + args.input_audio + ' ' + args.input_background + ' ' + str(args.repeater) + ' ' + str(args.duration) + ' ' + str(args.position) + ' ' + str(args.limit), shell=True)
