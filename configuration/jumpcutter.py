...
parser.add_argument('--output_file', type=str, default="jumpcut_result.mp4", help="the output file. (optional. if not included, it'll just modify the input file name)")
...
TEMP_FOLDER = "configuration/temp"
